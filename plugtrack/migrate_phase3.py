...
def migrate_phase3():
    ...
    try:
        ...
        with app.app_context():
            ...
            db.session.execute(db.text(create_session_meta_sql))
            ...
            db.session.execute(db.text(create_index_sql))
            ...
            result = db.session.execute(db.text(check_column_sql)).fetchone()
