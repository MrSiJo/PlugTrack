...
CATALOGUE: tuple[CatalogueEntry, ...] = (
    ...
    CatalogueEntry(
        ...
        value_type="bool",
        group_name="mqtt",
        label="Publish to MQTT / Home Assistant",
        description="Publish a charging summary to an MQTT broker for Home Assistant.",
        default_value="true",
    ),
    CatalogueEntry(
        key="mqtt_host",
    ...
    CatalogueEntry(
        ...
        description="MQTT password (stored encrypted).",
        default_value=None,
        is_secret=True,
    ),
    CatalogueEntry(
        ...
        group_name="mqtt",
        label="Base topic",
        description="Topic prefix; the summary is published to <base>/summary.",
        default_value="plugtrack",
    ),
)
