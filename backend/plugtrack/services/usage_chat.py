...
USAGE_SYSTEM_PROMPT = (
    ...
    "spend, energy (kWh), average p/kWh, miles driven, savings vs petrol, home vs public "
    "split, spend by network, and mileage / annual pace — over this month, last month, last "
